class Reservation < ActiveRecord::Base
  ...
  validate :available, :checkout_after_check_in, :guest_and_host_not_the_same
  ...
  def guest_and_host_not_the_same
    if guest_id == listing.host_id 
      errors.add(:guest_id, "You can't book your ouwn apartment.")
    end
  end

  def checkout_after_check_in 
